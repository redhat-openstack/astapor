...
class quickstack::neutron::allinone (
  ...
  $ceilometer_private_vip        = $quickstack::params::ceilometer_private_vip,
  $ceilometer_public_vip         = $quickstack::params::ceilometer_public_vip,
  ...
  $cinder                        = $quickstack::params::cinder,
  $cinder_admin_vip              = $quickstack::params::cinder_admin_vip,
  $cinder_private_vip            = $quickstack::params::cinder_private_vip,
  $cinder_public_vip             = $quickstack::params::cinder_public_vip,
  ...
  $glance                        = $quickstack::params::glance,
  $glance_admin_vip              = $quickstack::params::glance_admin_vip,
  $glance_private_vip            = $quickstack::params::glance_private_vip,
  $glance_public_vip             = $quickstack::params::glance_public_vip,
  ...
  $heat_cfn_admin_vip            = $quickstack::params::heat_cfn_admin_vip,
  $heat_cfn_private_vip          = $quickstack::params::heat_cfn_private_vip,
  $heat_cfn_public_vip           = $quickstack::params::heat_cfn_public_vip,

  $heat                          = $quickstack::params::heat,
  $heat_admin_vip                = $quickstack::params::heat_admin_vip,
  $heat_private_vip              = $quickstack::params::heat_private_vip,
  $heat_public_vip               = $quickstack::params::heat_public_vip,
  ...
  $keystone_admin_vip            = $quickstack::params::keystone_admin_vip,
  $keystone_private_vip          = $quickstack::params::keystone_private_vip,
  $keystone_public_vip           = $quickstack::params::keystone_public_vip,
  $keystonerc                    = 'True',
  ...
  $neutron_admin_vip             = $quickstack::params::neutron_admin_vip,
  $neutron_private_vip           = $quickstack::params::neutron_private_vip,
  ...
  $nova                          = $quickstack::params::nova,
  $nova_admin_vip                = $quickstack::params::nova_admin_vip,
  $nova_private_vip              = $quickstack::params::nova_private_vip,
  $nova_public_vip               = $quickstack::params::nova_public_vip,
  ...
  $ovs_enable_tunneling          = $quickstack::params::ovs_enable_tunneling,
  $ovs_tunnel_iface              = $quickstack::params::ovs_tunnel_iface,
  $ovs_tunnel_network            = $quickstack::params::ovs_tunnel_network,
...
#  $ovs_l2_population            = 'True',
  ...
  $swift_private_vip             = $quickstack::params::switf_private_vip,
  $swift_public_vip              = $quickstack::params::switf_public_vip,
