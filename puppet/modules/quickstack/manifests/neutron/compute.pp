...
class quickstack::neutron::compute (
  ...
  nova_config{
      ...
      'keystone_authtoken/auth_host':         value => $controller_priv_fqdn;
    }
  ...
  class { 'nova::compute':
      enabled => true,
      vncproxy_host => $controller_pub_fqdn,
  ...
  class { '::nova::network::neutron':
      ...
      neutron_url               => "http://${controller_priv_fqdn}:9696",
      neutron_admin_auth_url    => "http://${controller_priv_fqdn}:35357/v2.0",
  }
