  ...
  if (str2bool_i(map_params('include_cinder'))) {
    ...
    if str2bool_i("$volume") {
      ...
      class {'::quickstack::cinder_volume':
        ...
        backend_dell_sc        => $backend_dell_sc,
        backend_dell_sc_name   => $backend_dell_sc_name,
        ...
        dell_sc_san_ip           => $dell_sc_san_ip,
        dell_sc_san_login        => $dell_sc_san_login,
        dell_sc_san_password     => $dell_sc_san_password,
        dell_sc_iscsi_ip_address => $dell_sc_iscsi_ip_address,
        dell_sc_iscsi_port       => $dell_sc_iscsi_port,
